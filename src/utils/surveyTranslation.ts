    ...
    pages: [
      {
        ...
        elements: [
          ...
          },
          {
            ...
            isRequired: true,
            choices: [
              { text: t('survey.questions.q2.choices.paediatrician'), value: 'q2_a1' },
              { text: t('survey.questions.q2.choices.dietitian'), value: 'q2_a2' },
              { text: t('survey.questions.q2.choices.allergist'), value: 'q2_a3' },
          ...
          },
          {
            ...
            visibleIf: '{q5} = \'yes\'',
            choices: [
              { text: t('survey.questions.q5a.choices.online_course'), value: 'q5a_a1' },
              { text: t('survey.questions.q5a.choices.university_course'), value: 'q5a_a2' },
        ...
        elements: [
          ...
          },
          {
            ...
            choices: [
              ...
              { text: t('survey.questions.q8.choices.bronchiolitis'), value: 'q8_a2' },
              { text: t('survey.questions.q8.choices.family_history'), value: 'q8_a3' }
            ],
            showOtherItem: true,
          ...
          },
          {
            ...
            choices: [
              { text: t('survey.questions.q9a.elaborate.choices.soy_formula'), value: 'q9a_a1' },
              { text: t('survey.questions.q9a.elaborate.choices.hydrolysed_formula'), value: 'q9a_a2' },
              { text: t('survey.questions.q9a.elaborate.choices.restrict_allergens'), value: 'q9a_a3' },
              { text: t('survey.questions.q9a.elaborate.choices.emollients'), value: 'q9a_a4' },
              { text: t('survey.questions.q9a.elaborate.choices.prebiotics'), value: 'q9a_a5' },
              { text: t('survey.questions.q9a.elaborate.choices.vitamin_supplements'), value: 'q9a_a6' },
              { text: t('survey.questions.q9a.elaborate.choices.regular_formula'), value: 'q9a_a7' },
              { text: t('survey.questions.q9a.elaborate.choices.exclusive_breastfeeding'), value: 'q9a_a8' }
            ],
            showOtherItem: true,
            otherText: t('survey.questions.q9a.elaborate.other'),
            otherPlaceholder: t('survey.questions.q9a.elaborate.otherPlaceholder')
          },
          {
            type: 'radiogroup',
            name: 'q9b_main',
          ...
          },
          {
            ...
            choices: [
              { text: t('survey.questions.q9b.elaborate.choices.soy_formula'), value: 'q9b_a1' },
              { text: t('survey.questions.q9b.elaborate.choices.hydrolysed_formula'), value: 'q9b_a2' },
              { text: t('survey.questions.q9b.elaborate.choices.restrict_allergens'), value: 'q9b_a3' },
              { text: t('survey.questions.q9b.elaborate.choices.emollients'), value: 'q9b_a4' },
              { text: t('survey.questions.q9b.elaborate.choices.prebiotics'), value: 'q9b_a5' },
              { text: t('survey.questions.q9b.elaborate.choices.vitamin_supplements'), value: 'q9b_a6' },
              { text: t('survey.questions.q9b.elaborate.choices.regular_formula'), value: 'q9b_a7' },
              { text: t('survey.questions.q9b.elaborate.choices.exclusive_breastfeeding'), value: 'q9b_a8' }
            ],
            showOtherItem: true,
            otherText: t('survey.questions.q9b.elaborate.other'),
            otherPlaceholder: t('survey.questions.q9b.elaborate.otherPlaceholder')
          },
          {
            type: 'radiogroup',
          ...
          },
          {
            ...
            choices: [
              ...
              { text: t('survey.questions.q14.choices.multivitamin'), value: 'q14_a2' },
              { text: t('survey.questions.q14.choices.omega3'), value: 'q14_a3' },
              { text: t('survey.questions.q14.choices.probiotic'), value: 'q14_a4' },
              { text: t('survey.questions.q14.choices.prebiotic'), value: 'q14_a5' },
              { text: t('survey.questions.q14.choices.synbiotic'), value: 'q14_a6' },
              { text: t('survey.questions.q14.choices.vitamin_a'), value: 'q14_a7' },
              { text: t('survey.questions.q14.choices.vitamin_c'), value: 'q14_a8' },
              { text: t('survey.questions.q14.choices.vitamin_d'), value: 'q14_a9' },
              { text: t('survey.questions.q14.choices.no_supplements'), value: 'q14_a10' }
            ],
            showOtherItem: true,
          ...
          },
          {
            ...
            isRequired: true,
            choices: [
              { text: t('survey.questions.q15.choices.1_day'), value: 'q15_18_a1' },
              { text: t('survey.questions.q15.choices.1_3_days'), value: 'q15_18_a2' },
              { text: t('survey.questions.q15.choices.more_3_days'), value: 'q15_18_a3' }
            ]
          },
          {
            type: 'dropdown',
            ...
            isRequired: true,
            choices: [
              { text: t('survey.questions.q16.choices.1_day'), value: 'q15_18_a1' },
              { text: t('survey.questions.q16.choices.1_3_days'), value: 'q15_18_a2' },
              { text: t('survey.questions.q16.choices.more_3_days'), value: 'q15_18_a3' }
            ]
          },
          {
            type: 'dropdown',
            ...
            isRequired: true,
            choices: [
              { text: t('survey.questions.q17.choices.1_day'), value: 'q15_18_a1' },
              { text: t('survey.questions.q17.choices.1_3_days'), value: 'q15_18_a2' },
              { text: t('survey.questions.q17.choices.more_3_days'), value: 'q15_18_a3' }
            ]
          },
          {
            type: 'dropdown',
            ...
            isRequired: true,
            choices: [
              { text: t('survey.questions.q18.choices.1_day'), value: 'q15_18_a1' },
              { text: t('survey.questions.q18.choices.1_3_days'), value: 'q15_18_a2' },
              { text: t('survey.questions.q18.choices.more_3_days'), value: 'q15_18_a3' }
            ]
          }
        ]
      }
  ...
  return [
    {
      ...
      items: [
        ...
        { label: t('foodItems.starch.gluten_free_cereals'), value: 'g_starch_2' },
        { label: t('foodItems.starch.maize_products'), value: 'g_starch_3' },
        { label: t('foodItems.starch.potato_sweet_potato'), value: 'g_starch_4' },
    ...
    },
    {
      ...
      items: [
        ...
        { label: t('foodItems.additional.family_meal_salt'), value: 'g_addit_guid_2' },
        { label: t('foodItems.additional.family_meal_no_salt'), value: 'g_addit_guid_3' },
        { label: t('foodItems.additional.mashed_food'), value: 'g_addit_guid_4' },
        { label: t('foodItems.additional.pureed_food'), value: 'g_addit_guid_5' },
        { label: t('foodItems.additional.finger_food'), value: 'g_addit_guid_6' },
        { label: t('foodItems.additional.baby_led_weaning'), value: 'g_addit_guid_7' }
      ]
    }
  ];
};